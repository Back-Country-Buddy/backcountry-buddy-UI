...
"No one" is a generalization, of course. But in a phone call with Liz Riggs Meder, the Director Of Recreational Programs at AIARE, she echoed this sentiment. Liz said the most useful thing she can think of to help reduce avalanche accidents would be to make the booklet into an app. "No one wants to dig up their book and write things down while out skiing. It needs to be where people already are: their phones," she said. That's where Backcountry Buddy comes in.
...
## Deployment
[Deployment Link](https://backcountry-buddy-ui.vercel.app/)
