      ...
      <section className="plan">
        ...
        <article className="plan-info">
          ...
          <h4 className="sub-category">
            1) Discuss current & forecast weather factors that can affect travel
            or hazard
          </h4>
          <p className="tour-input">{currentTour.hazardWeather}</p>
          <h4 className="sub-category">
            2) Identify the avalanche problem and location. Discuss the danger
            trend and timing
          </h4>
          <p className="tour-input">{currentTour.hazardAvalanche}</p>
          <h4 className="sub-category">
            3) Discuss the advisory's key message
          </h4>
