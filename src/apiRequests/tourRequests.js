...
export const getTours = (auth, tourId) => {
  return fetch(`https://backcountry-restapi.herokuapp.com/api/private/v1/user/${tourId}/tour`,
    {
    headers: header(auth)
  })
}
...
export const getUsersInTour = (auth, tourId) => {
  return fetch(`https://backcountry-restapi.herokuapp.com/api/private/v1/tour_user?tour_id=${tourId}`,
    {
    headers: header(auth)
  })
}
